@php
    ...
    $menu = new \OctopusOsc\AdminLayout\Core\Adapters\Menu(theme()->getOption('menu', 'documentation'), theme()->getPagePath());
    ...
    <h1 class="d-flex align-items-center text-dark my-1 fs-4">
        ...
        <!--begin::Separator-->
            ...
            <small class="text-gray-700 fs-7 fw-bold my-1 ms-1">
                {{ theme()->getOption('pages', 'description') }}
            </small>
            <!--end::Description-->
        @endif
    </h1>
            ...
            <!--begin::Item-->
                @if ( $item['active'] === true )
                    <li class="breadcrumb-item text-dark">
                        ...
                        @if (theme()->getOption('pages', 'exclusive') === true)
