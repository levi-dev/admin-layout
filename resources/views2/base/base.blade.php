...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('assets/' . theme()->getTheme() . '/' .theme()->getOption('assets', 'favicon')) }}"/>
    ...
    @if (theme()->hasOption('page', 'assets/vendors/css'))
        ...
        @foreach (array_unique(theme()->getOption('pages', 'assets/vendors/css')) as $file)
    ...
    @if (theme()->hasOption('page', 'assets/custom/css'))
        ...
        @foreach (array_unique(theme()->getOption('pages', 'assets/custom/css')) as $file)
            {!! preloadCss(assetCustom($file)) !!}
        @endforeach
...
@if (theme()->hasOption('assets', 'js'))
    ...
    @foreach (array_unique(theme()->getOption('assets', 'js')) as $file)
        <script src="{{ asset( 'assets/' . theme()->getTheme() . '/' .$file) }}"></script>
    @endforeach
...
@if (theme()->hasOption('page', 'assets/vendors/js'))
    ...
    @foreach (array_unique(theme()->getOption('pages', 'assets/vendors/js')) as $file)
        <script src="{{ asset( 'assets/' . theme()->getTheme() . '/' .$file) }}"></script>
    @endforeach
...
@if (theme()->hasOption('page', 'assets/custom/js'))
    ...
    @foreach (array_unique(theme()->getOption('pages', 'assets/custom/js')) as $file)
        <script src="{{ asset( 'assets/' . theme()->getTheme() . '/' .$file) }}"></script>
    @endforeach
