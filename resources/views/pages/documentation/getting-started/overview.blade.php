...
@php
    $items = [
        ...
        [
            ...
            'link-path' => theme()->getOption('product', 'preview') . '/' . theme()->getTheme() . '/layout-builder.html',
            'target' => '_blank',
        ],
        ...
        [
            ...
            'link-path' => theme()->getOption('product', 'preview') . '/' . theme()->getTheme() . '/documentation/base/utilities.html',
            'target' => '_blank',
        ],
        ...
        [
            ...
            'link-path' => theme()->getOption('product', 'preview') . '/' . theme()->getTheme() . '/documentation/forms/password-meter.html',
            'target' => '_blank',
        ],
        ...
        [
            ...
            'link-text' => 'Learn more',
            'link-path' => theme()->getOption('product', 'preview') . '/' . theme()->getTheme() . '/documentation/forms/flatpickr.html',
            'target' => '_blank',
        ],
        ...
        [
            ...
            'link-path' => theme()->getOption('product', 'preview') . '/' . theme()->getTheme() . '/documentation/general/icons/duotone.html',
            'target' => '_blank',
        ]
    ];
@endphp
