 ...
 */
class Theme extends \OctopusOsc\AdminLayout\Core\Theme
{
    public static $page = '';
     ...
     * @param  string  $demo
     */
    public static function setTheme($demo = 'admin')
    {
        Theme::$demo = $demo;
    }
     ...
     * @param  string  $demo
     */
    public static function setDemo($demo = 'admin')
    {
        Theme::$demo = $demo;
    }
    ...
    public static function printHtmlClasses($scope, $full = true)
    {
        ...
        \OctopusOsc\AdminLayout\Core\Theme::printHtmlClasses($scope, $full);
    ...
    public static function printHtmlAttributes($scope)
    {
        ...
        // Call the function from core Theme
        \OctopusOsc\AdminLayout\Core\Theme::printHtmlAttributes($scope);
    ...
    public static function printCssVariables($scope)
    {
        ...
        // Call the function from core Theme
        \OctopusOsc\AdminLayout\Core\Theme::printCssVariables($scope);
    ...
    {
        return theme()->getOption('pages', 'title');
    }
    ...
    {
        return 'assets/' . theme()->getTheme().'/media/';
    }
    ...
    public static function getPagePath()
    {
        ...
        $segments = request()->segments();
        if (!empty($segments)) {
            \OctopusOsc\AdminLayout\Core\Theme::$page = implode('/', $segments);
        }

        return \OctopusOsc\AdminLayout\Core\Theme::getPagePath();
    }
