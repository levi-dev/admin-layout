...
namespace OctopusOsc\AdminLayout\Core\Bootstraps;

use OctopusOsc\AdminLayout\Core\Adapters\BootstrapBase;
use OctopusOsc\AdminLayout\Core\Adapters\Menu;
use OctopusOsc\AdminLayout\Core\Adapters\Theme;
...
//        self::$asideMenu = new Menu(config("menu-admin.main") ?: [], Theme::getPagePath() );
        self::$asideMenu = new Menu(config("backend.menu_test.main") ?: [], Theme::getPagePath() );
